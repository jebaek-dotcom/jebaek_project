...
def create_proposal(company_name: str, url: str, output_dir: str = '../output') -> str:
    """
    마케팅 제안서 생성
    ...
    filename = f"마케팅제안서_{safe_company_name}_{timestamp}.docx"
...
def main():
    ...
    try:
        file_path = create_proposal(company_name, url)
